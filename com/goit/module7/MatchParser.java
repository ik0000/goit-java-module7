...
public class MatchParser {
    ...
    public Double getVariable(String variableName)
    {
        if (!variables.containsKey(variableName)) {
            System.err.println( "Error: Trying  to get non-existent variable '"+variableName+"'" );
            return 0.0;
        }
    ...
    public double Parse(String s) throws Exception
    {
        ...
        if (!result.rest.isEmpty()) {
            System.err.println("Error: can't fully parse string remainder that can't be parsed is: " + result.rest);
